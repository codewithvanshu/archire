...
export default function ArchitectNavBar() {
      ...
      <div className="ml-auto">
        <DropdownMenu>
          ...
          <DropdownMenuContent className=" bg-background">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuGroup>
              <Link href="/architect/account"><DropdownMenuItem>My Account <DropdownMenuShortcut>⇧⌘Q</DropdownMenuShortcut></DropdownMenuItem></Link>
              <Link href="/architect/settings"><DropdownMenuItem>Settings<DropdownMenuShortcut>⇧⌘B</DropdownMenuShortcut></DropdownMenuItem></Link>
            </DropdownMenuGroup>
            <DropdownMenuSeparator />
